"""Generate text from a v2 checkpoint (MLA + MoE + Hyper-Connections + MTP).

Usage:
    uv run python sample_v2.py --ckpt checkpoints_v2/model_005000.pt \
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Sample from a model_v2 checkpoint")
